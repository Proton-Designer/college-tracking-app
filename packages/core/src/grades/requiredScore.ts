...
/**
 * Required-score solver — DOMAIN_ENGINE_SPEC.md §2.
 *
 * neededPct is dimensionally: (percentage points still needed) / (remaining weight as a
 * fraction of 100), i.e. `(target - earnedWeightPoints) / remainingWeightPct * 100`. The
 * spec's pseudocode omits the `* 100`; that omission is a notational shorthand, not a
 * different formula — verified by hand against a full 4-category syllabus in
