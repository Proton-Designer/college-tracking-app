// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/bounceback/bounceBack.ts -- do not edit directly.
// Regenerate with `npm run build:core-for-deno` after any packages/core change.

import type { Confidence, LocalDate } from '../types.ts';
import { compareLocalDate, daysBetween } from '../util/date.ts';
