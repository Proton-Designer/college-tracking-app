// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/deen/prayerStatus.ts -- do not edit directly.
...
import { localDateFromInstant } from '../util/localToday.ts';
import {
  PRAYER_NAMES,
