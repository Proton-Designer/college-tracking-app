// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/grades/requiredScore.ts -- do not edit directly.
// Regenerate with `npm run build:core-for-deno` after any packages/core change.

import type { CourseGradeResult } from './types.ts';
