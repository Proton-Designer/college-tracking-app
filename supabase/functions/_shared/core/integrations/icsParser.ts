// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/integrations/icsParser.ts -- do not edit directly.
// Regenerate with `npm run build:core-for-deno` after any packages/core change.

import { addDays, type LocalDate } from '../util/date.ts';
