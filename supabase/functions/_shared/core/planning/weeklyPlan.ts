// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/planning/weeklyPlan.ts -- do not edit directly.
...
import type { TimeInterval } from './freeIntervals.ts';
import { intervalMinutes } from './freeIntervals.ts';
