// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/reports/nightlyReportTypes.ts -- do not edit directly.
...
import type { BounceBackResult } from '../bounceback/bounceBack.ts';
import type { CauseTrendEntry, FrictionDistribution } from '../friction/frictionAnalytics.ts';
import type { CourseGradeProjection } from '../grades/types.ts';
import type { PlanningExecutionResult } from '../planning/planningExecutionGap.ts';
import type { RecoveryModeResult } from '../recovery/trigger.ts';
import type { RiskAssessment } from '../risk/riskAssessment.ts';
import type { LocalDate } from '../util/date.ts';
