// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/retrieval/confidence.ts -- do not edit directly.
...
import type { AttemptEntry } from './scheduler.ts';
