// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/risk/assignmentRisk.ts -- do not edit directly.
// Regenerate with `npm run build:core-for-deno` after any packages/core change.

import type { Confidence, LocalDate, TraceEntry } from '../types.ts';
