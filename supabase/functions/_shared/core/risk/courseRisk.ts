// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/risk/courseRisk.ts -- do not edit directly.
// Regenerate with `npm run build:core-for-deno` after any packages/core change.

import type { Confidence, TraceEntry } from '../types.ts';
import { bandForScore, type RiskBand } from './assignmentRisk.ts';
