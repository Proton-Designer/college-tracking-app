// GENERATED by scripts/build-core-for-deno.mjs from packages/core/src/risk/dayBand.ts -- do not edit directly.
// Regenerate with `npm run build:core-for-deno` after any packages/core change.

import type { RiskBand } from './assignmentRisk.ts';
import type { DeliverableRisk } from './riskAssessment.ts';
