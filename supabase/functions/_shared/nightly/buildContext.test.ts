...
Deno.test("buildNightlyAnalysisRequest: the hand-written tool schema accepts a real DailyAnalysis-shaped response", () => {
  ...
  const candidateResponse = {
    ...
    lenses: {
      executive_coach: "Deep work landed but MITs slipped -- protect the first block tomorrow before anything else gets scheduled into it.",
      academic_strategist: "Midterm 2 is 7 days out with low confidence -- this is the week to close that gap, not coast on it.",
      behavior_analyst: "The kill habit held tonight, which tracks with the earlier bedtime two days running.",
      skeptic: "The 95 actual deep-work minutes came from one session -- one data point isn't yet a pattern worth trusting.",
      systems_engineer: "Move the deep-work block earlier in the day rather than asking for more willpower at the same time slot that's already failed twice.",
      motivator: "Resisting the kill habit tonight after two straight misses is the actual turnaround, not the deep-work minutes.",
      recovery_coach: "",
    },
